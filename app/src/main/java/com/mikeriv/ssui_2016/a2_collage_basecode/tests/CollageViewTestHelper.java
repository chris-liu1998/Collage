...
import com.mikeriv.ssui_2016.a2_collage_basecode.layout.CircleLayout;
import com.mikeriv.ssui_2016.a2_collage_basecode.layout.ColumnLayout;
...
import com.mikeriv.ssui_2016.a2_collage_basecode.layout.PileLayout;
import com.mikeriv.ssui_2016.a2_collage_basecode.layout.RowLayout;
...
//        **/
        ...
        c.addChild(s4);
        //SolidBackDrop o = new SolidBackDrop(5, 300, 1000, 1080, Color.LTGRAY);
    ...
    private static final void runTest4(CollageView collageView, Context context) {
        ...
        Resources res = context.getResources();
        SolidBackDrop rootVisualElement = new SolidBackDrop(0, 0, 2000, 2000, Color.YELLOW);
        CircleLayout c = new CircleLayout(0, 0, 1000, 1000, 500, 500, 200);
        rootVisualElement.addChild(c);
        for (int i = 0; i < 5; i++) {
            c.addChild(new IconImage(10, 110, BitmapFactory.decodeResource(res, R.drawable.ic_noun_narwhal)));
        }
        rootVisualElement.addChild(new TextVisualElement(500, 500, "5 Whales！", Typeface.DEFAULT_BOLD, 40f));
        SolidBackDrop s = new SolidBackDrop(0, 900, 2000, 2000, Color.MAGENTA);
        rootVisualElement.addChild(s);
        RowLayout r = new RowLayout(10, 1100, 1000, 100);
        rootVisualElement.addChild(r);
        for (int i = 0; i < 9; i++) {
            r.addChild(new IconImage(10, 110, BitmapFactory.decodeResource(res, R.drawable.ic_noun_cat)));
        }
        rootVisualElement.addChild(new TextVisualElement(400, 1000, "9 Cats！", Typeface.DEFAULT_BOLD, 40f));
        updateCollageViewWithRoot(collageView, rootVisualElement);
    }
